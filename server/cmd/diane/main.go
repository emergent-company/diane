...
func main() {
	...
	fmt.Println("    --check       Non-interactive version check (JSON mode)")
	fmt.Println("    --auto        Non-interactive auto-upgrade with rollback")
	fmt.Println("    rollback      Revert to the previous version")
